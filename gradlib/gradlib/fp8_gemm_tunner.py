...
def get_dtype(dtype_str):
    ...
    if dtype_str == 'f32':
        ...
        print('>>> Warning! Invalid dtype', dtype_str, 'using default dtype f8')
    return dtype
...
if __name__ == '__main__':
    ...
    parser.add_argument("--indtype", type=str, default='f8', help="dtype f32 f16 bf16 fp8")
    parser.add_argument("--outdtype", type=str, default='f16', help="dtype f32 f16 bf16 fp8")
